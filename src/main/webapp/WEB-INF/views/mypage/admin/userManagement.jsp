...
<body>
	<div id="userManagement">
		<ul class="nav nav-tabs">
			<li class="active"><a data-toggle="tab"
				href="#userManagementAllUser">전체회원</a></li>
			<li><a data-toggle="tab" href="#userManagementDeclaration">신고당한
					회원</a></li>
	...
	<div class="userManagementSearch">
		<form action="" method=""
			onsubmit="return userManagementValidityCheck()">
			<select name="">
				<option value="전체회원">전체회원</option>
				<option value="아이디">아이디</option>
				<option value="이름">이름</option>
				<option value="주소">주소</option>
			</select> <input type="text" name=""> <input type="submit" value="검색">
		</form>
	</div>
