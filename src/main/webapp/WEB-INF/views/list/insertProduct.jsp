...
<script type="text/javascript"
	src="<c:url value='/resources/editor/js/HuskyEZCreator.js'/>"
...
<body>
	...
	<div class="container">
		...
		<form action="<c:url value='/editor/submit'/>" method="post" id="frm"
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<select class="form-controler" id="selectCategory"
							name="selectCategory">
				...
				<div class="form-group">
					...
					<div class="col-lg-3">
						<input type="text" name="sharingPrice" id=sharingPrice
							" class="form-control">
					</div>
					<div class="col-lg-1">
						<p class="form-control-static">원/일</p>
					</div>

					<label for="productState" class="control-label col-lg-1">물건상태</label>
					<div class="col-lg-2">
						<select class="form-controler" id="productState"
							name="productState">
							<option>상</option>
							<option>중</option>
							<option>하</option>
				...
				<div class="form-group">
					<button type="button" id="savebutton" value="서버전송"
						class="btn btn-default col-lg-offset-9 col-lg-1">전송</button>
