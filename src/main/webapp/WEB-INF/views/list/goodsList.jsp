...
<body>
	...
	<!-- mobile goodsListCategory + goodsDetailSearch -->
		...
		<div id="goodsListItemForm">
				<div class="goodsListItem">
					<ul>
						<li><img src="<c:url value='/resources/image/NoteBook.jpg'/>" alt="book"><a href="<c:url value='/board/goodsDetail'/>"><span class="material-icons goodsDetailViewSee">&#xE8F4;</span></a></li>
						<li>제품명 : IOS</li>
						<li>가격 : 0원 / 0 일</li>
	...
	<form action="" method="post" name="goodsListDetailSearchDialog" onsubmit="return detailSearchValidityCheck()">
		...
		<ul>
		<li><input type="checkbox" name="서울">서울</li><li><input type="checkbox" name="인천">인천</li>
		<li><input type="checkbox" name="대전">대전</li><li><input type="checkbox" name="대구">대구</li>
		<li><input type="checkbox" name="부산">부산</li><li><input type="checkbox" name="광주">광주</li>
		<li><input type="checkbox" name="경기">경기</li><li><input type="checkbox" name="강원">강원</li>
		<li><input type="checkbox" name="충남">충남</li><li><input type="checkbox" name="충북">충북</li>
		<li><input type="checkbox" name="전북">전북</li><li><input type="checkbox" name="전남">전남</li>
		<li><input type="checkbox" name="경북">경북</li><li><input type="checkbox" name="경남">경남</li>
		<li><input type="checkbox" name="제주">제주</li>
		</ul>
		</div>
			</div>
		<div class="goodsReservation">
		<span>예약일</span> <input type="text" name="goodsReservation" placeholder="0000년00월00일~0000년00월00일">
		</div>
		<div class="goodsSearch">
		<span>검색어</span> <input type="text" name="goodsSearch"><button><span class="glyphicon glyphicon-search"></span></button>
		</div>
		</form>
	</div>
